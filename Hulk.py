...
def loginSC():
	...
	if username =="Subscribe" and password =="HulkGaming":
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/channel/UCgKZe6R7Jn30AY7v_wIyj8w')
				menu()
